...
func (x *DutyCycleStats) GetWindow() *duration.Duration {
	if x != nil {
		return x.Window
	}
	return nil
...
type DutyCycleBand struct {
	...
	// Max. allowed load.
	LoadMax *duration.Duration `protobuf:"bytes,4,opt,name=load_max,json=loadMax,proto3" json:"load_max,omitempty"`
	// Tracked load (within the window of the regionlation).
	LoadTracked *duration.Duration `protobuf:"bytes,5,opt,name=load_tracked,json=loadTracked,proto3" json:"load_tracked,omitempty"`
}
...
func (x *DutyCycleBand) GetLoadMax() *duration.Duration {
	if x != nil {
		return x.LoadMax
	}
	return nil
...
func (x *DutyCycleBand) GetLoadTracked() *duration.Duration {
	if x != nil {
...
func (x *UplinkRxInfoLegacy) GetTime() *timestamp.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
func (x *UplinkRxInfoLegacy) GetTimeSinceGpsEpoch() *duration.Duration {
	if x != nil {
...
type UplinkRxInfo struct {
	...
	GwTime *timestamp.Timestamp `protobuf:"bytes,3,opt,name=gw_time,json=gwTime,proto3" json:"gw_time,omitempty"`
	// Network Server RX time (set by the NS on receiving the uplink).
	NsTime *timestamp.Timestamp `protobuf:"bytes,17,opt,name=ns_time,json=nsTime,proto3" json:"ns_time,omitempty"`
	// RX time as time since GPS epoch (set if the gateway has a GNSS module).
	TimeSinceGpsEpoch *duration.Duration `protobuf:"bytes,4,opt,name=time_since_gps_epoch,json=timeSinceGpsEpoch,proto3" json:"time_since_gps_epoch,omitempty"`
	// Fine-timestamp.
	// This timestamp can be used for TDOA based geolocation.
	FineTimeSinceGpsEpoch *duration.Duration `protobuf:"bytes,5,opt,name=fine_time_since_gps_epoch,json=fineTimeSinceGpsEpoch,proto3" json:"fine_time_since_gps_epoch,omitempty"`
	// RSSI.
...
func (x *UplinkRxInfo) GetGwTime() *timestamp.Timestamp {
	if x != nil {
		return x.GwTime
	}
	return nil
...
func (x *UplinkRxInfo) GetNsTime() *timestamp.Timestamp {
	if x != nil {
		return x.NsTime
	}
	return nil
...
func (x *UplinkRxInfo) GetFineTimeSinceGpsEpoch() *duration.Duration {
	if x != nil {
...
func (x *MeshHeartbeat) GetTime() *timestamp.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
