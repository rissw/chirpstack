...
type RelayServiceClient interface {
	...
	AddDevice(ctx context.Context, in *AddRelayDeviceRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// RemoveDevice removes the given device from the relay.
	RemoveDevice(ctx context.Context, in *RemoveRelayDeviceRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *relayServiceClient) AddDevice(ctx context.Context, in *AddRelayDeviceRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *relayServiceClient) RemoveDevice(ctx context.Context, in *RemoveRelayDeviceRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type RelayServiceServer interface {
	...
	// AddDevice adds the given device to the relay.
	AddDevice(context.Context, *AddRelayDeviceRequest) (*empty.Empty, error)
	// RemoveDevice removes the given device from the relay.
	RemoveDevice(context.Context, *RemoveRelayDeviceRequest) (*empty.Empty, error)
	// ListDevices lists the devices for the given relay.
...
func (UnimplementedRelayServiceServer) AddDevice(context.Context, *AddRelayDeviceRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddDevice not implemented")
}
func (UnimplementedRelayServiceServer) RemoveDevice(context.Context, *RemoveRelayDeviceRequest) (*empty.Empty, error) {
