...
type MulticastGroupServiceClient interface {
	...
	AddGateway(ctx context.Context, in *AddGatewayToMulticastGroupRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	// Remove a gateway from the multicast group.
	RemoveGateway(ctx context.Context, in *RemoveGatewayFromMulticastGroupRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	...
	FlushQueue(ctx context.Context, in *FlushMulticastGroupQueueRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *multicastGroupServiceClient) AddGateway(ctx context.Context, in *AddGatewayToMulticastGroupRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *multicastGroupServiceClient) RemoveGateway(ctx context.Context, in *RemoveGatewayFromMulticastGroupRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
func (c *multicastGroupServiceClient) FlushQueue(ctx context.Context, in *FlushMulticastGroupQueueRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(empty.Empty)
...
type MulticastGroupServiceServer interface {
	...
	// Add a gateway to the multicast group.
	AddGateway(context.Context, *AddGatewayToMulticastGroupRequest) (*empty.Empty, error)
	// Remove a gateway from the multicast group.
	RemoveGateway(context.Context, *RemoveGatewayFromMulticastGroupRequest) (*empty.Empty, error)
	// Add the given item to the multicast group queue.
	Enqueue(context.Context, *EnqueueMulticastGroupQueueItemRequest) (*EnqueueMulticastGroupQueueItemResponse, error)
	// Flush the queue for the given multicast group.
	FlushQueue(context.Context, *FlushMulticastGroupQueueRequest) (*empty.Empty, error)
	// List the items in the multicast group queue.
...
func (UnimplementedMulticastGroupServiceServer) AddGateway(context.Context, *AddGatewayToMulticastGroupRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddGateway not implemented")
}
func (UnimplementedMulticastGroupServiceServer) RemoveGateway(context.Context, *RemoveGatewayFromMulticastGroupRequest) (*empty.Empty, error) {
...
func (UnimplementedMulticastGroupServiceServer) FlushQueue(context.Context, *FlushMulticastGroupQueueRequest) (*empty.Empty, error) {
