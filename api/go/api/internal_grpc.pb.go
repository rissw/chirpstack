...
type InternalServiceClient interface {
	...
	ListRegions(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListRegionsResponse, error)
...
func (c *internalServiceClient) ListRegions(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListRegionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *internalServiceClient) GetVersion(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetVersionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type InternalServiceServer interface {
	...
	// ListRegions lists the available (configured) regions.
	ListRegions(context.Context, *empty.Empty) (*ListRegionsResponse, error)
	// GetRegion returns the region details for the given region.
...
func (UnimplementedInternalServiceServer) ListRegions(context.Context, *empty.Empty) (*ListRegionsResponse, error) {
...
func (UnimplementedInternalServiceServer) GetVersion(context.Context, *empty.Empty) (*GetVersionResponse, error) {
...
func _InternalService_ListRegions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InternalServiceServer).ListRegions(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _InternalService_GetVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InternalServiceServer).GetVersion(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
