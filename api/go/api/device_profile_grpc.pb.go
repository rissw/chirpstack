...
type DeviceProfileServiceClient interface {
	...
	ListAdrAlgorithms(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListDeviceProfileAdrAlgorithmsResponse, error)
}
...
func (c *deviceProfileServiceClient) ListAdrAlgorithms(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ListDeviceProfileAdrAlgorithmsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type DeviceProfileServiceServer interface {
	...
	// List available ADR algorithms.
	ListAdrAlgorithms(context.Context, *empty.Empty) (*ListDeviceProfileAdrAlgorithmsResponse, error)
...
func (UnimplementedDeviceProfileServiceServer) ListAdrAlgorithms(context.Context, *empty.Empty) (*ListDeviceProfileAdrAlgorithmsResponse, error) {
...
func _DeviceProfileService_ListAdrAlgorithms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceProfileServiceServer).ListAdrAlgorithms(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
